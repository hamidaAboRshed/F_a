...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                <?php 
                        $erorr='<p class="text-danger">
                            '.$this->session->userdata('error').'
                        </p> <br>';
                        echo $erorr;
                        $this->session->unset_userdata('error');
                ?>
                <div id='MessageAlertDiv'>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/lib/jquery/jquery.cookie.js"></script>
    <!--Custom JavaScript -->
...
<!--     <script src="<?php echo base_url();?>/assets/js/custom.js"></script> -->
    ...
    <script type="text/javascript" src="<?php echo base_url();?>/assets/grid-js/home_notification.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/grid-js/home_message.js"></script>
    <!-- steps form -->
