        ...
        <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">                     
                    <li><i class="fas fa-user-tie"></i> <a href="<?php echo site_url('Customer')?>">Customer</a></li>
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="fa fa-table"></i><a href="<?php echo site_url('Order')?>">Order</a></li>
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="menu-icon fas fa-chart-line"></i><a href="<?php echo site_url('Activity/Add_Activity')?>">Activites</a></li>
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="menu-icon fas fa-users-cog"></i><a href="#">Employee</a></li>
            ...
            <li class="menu-title">Documents</li><!-- /.menu-title -->
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="menu-icon fa fa-fort-awesome"></i><a href="#">reg</a></li>
