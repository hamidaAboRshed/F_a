...
class Global_model extends CI_Model
{
    ...
    public function insertArrayData($table,$data)
    {
    ...
    public function updateByColumn($table, $data, $col_name, $col_value)
    {
    ...
    // delete rows with specific ids
    public function delete_rows($table,$column,$ids,$ids_column,$column_id=null)
	{
		$this->db->where($column,$column_id)
				 ->where_in($ids_column,$ids);
		$this->db->delete($table);
	}
}
