...
class Permission extends CI_Model
{
    ...
    public function all()
    {
        return $this->db->get_where("permission", array("deleted_at" => null))->result();
    }
    ...
    {
        return $this->db->update('permission', $data, array('id' => $data['id']));
    }
    ...
    public function delete($id)
    {
        ...
        return $this->find($id) ? $this->db->update('permission', $data, array('id' => $id)) : 0;
    }
}